...
<html>
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="max-width:480px;width:100%;background-color:#111111;border:1px solid #262626;border-radius:16px;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
            ...
            <tr>
              <td align="center" style="padding:0 32px;">
                <div style="font-size:20px;font-weight:700;color:#ffffff;">Welcome to Brixen</div>
                <div style="margin-top:8px;font-size:14px;line-height:20px;color:#9a9a9a;">
                  Your account has been activated. Here are your login details.
                </div>
              </td>
            </tr>
            <tr>
              <td style="padding:28px 32px 8px 32px;">
                <div style="background-color:#000000;border:1px solid #2e2e2e;border-radius:12px;padding:20px 24px;">
                  <div style="font-size:12px;color:#6e6e6e;text-transform:uppercase;letter-spacing:1px;">Email</div>
                  <div style="margin-top:4px;font-size:15px;color:#ffffff;">${email}</div>
                  <div style="margin-top:16px;font-size:12px;color:#6e6e6e;text-transform:uppercase;letter-spacing:1px;">Temporary Password</div>
                  <div style="margin-top:4px;font-family:'SF Mono',Consolas,'Courier New',monospace;font-size:20px;font-weight:700;letter-spacing:4px;color:#ffffff;">${tempPassword}</div>
                </div>
              </td>
            </tr>
            <tr>
              <td align="center" style="padding:24px 32px 40px 32px;">
                <div style="font-size:13px;line-height:19px;color:#6e6e6e;">
                  For your security, please sign in and change this password as soon as possible. You can change it anytime from the app.
                </div>
              </td>
            </tr>
            <tr>
  ...
  const text = `Welcome to Brixen! Your account has been activated.\n\nEmail: ${email}\nTemporary password: ${tempPassword}\n\nFor your security, please sign in and change this password as soon as possible. You can change it anytime from the app.`;
